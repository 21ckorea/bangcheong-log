/*
  ...
  - You are about to drop the column `keywords` on the `User` table. All the data in the column will be lost.
...
-- AddForeignKey
ALTER TABLE "FavoriteProgram" ADD CONSTRAINT "FavoriteProgram_programId_fkey" FOREIGN KEY ("programId") REFERENCES "Program"("id") ON DELETE CASCADE ON UPDATE CASCADE;
